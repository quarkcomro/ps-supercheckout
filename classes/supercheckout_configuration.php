...
class SupercheckoutConfiguration
{
    public function processPostData($data = array())
    {
        ...
        // changes done by kanishka >> When the customer profile is enabled but no profile is created or no profile is enabled then allow to edit addresses fields in the address section
        $any_active_profile = 0;
        ...
        if (isset($existing_profile_datas) && !empty($existing_profile_datas)) {
            foreach ($existing_profile_datas as $key => $data) {
                if ($data['active']) {
                    $any_active_profile = $data['active'];
                }
            }
        }
        if ($configuration['enable_customer_profile'] == 1 && !empty($existing_profile_datas) && $any_active_profile) {
            // changes done by kanishka >> When the customer profile is enabled but no profile is created or no profile is enabled then allow to edit addresses fields in the address section
            //Payment Address
            $configuration['payment_address']['firstname']['logged']['require'] = 1;
            $configuration['payment_address']['firstname']['logged']['display'] = 1;
            $configuration['payment_address']['lastname']['logged']['require'] = 1;
            $configuration['payment_address']['lastname']['logged']['display'] = 1;
            $configuration['payment_address']['company']['logged']['require'] = 1;
            $configuration['payment_address']['company']['logged']['display'] = 1;
            $configuration['payment_address']['vat_number']['logged']['require'] = 1;
            $configuration['payment_address']['vat_number']['logged']['display'] = 1;
            $configuration['payment_address']['dni']['logged']['require'] = 1;
            $configuration['payment_address']['dni']['logged']['display'] = 1;
            $configuration['payment_address']['address1']['logged']['require'] = 1;
            $configuration['payment_address']['address1']['logged']['display'] = 1;
            $configuration['payment_address']['address2']['logged']['require'] = 1;
            $configuration['payment_address']['address2']['logged']['display'] = 1;
            $configuration['payment_address']['postcode']['logged']['require'] = 1;
            $configuration['payment_address']['postcode']['logged']['display'] = 1;
            $configuration['payment_address']['city']['logged']['require'] = 1;
            $configuration['payment_address']['city']['logged']['display'] = 1;
            $configuration['payment_address']['id_state']['logged']['require'] = 1;
            $configuration['payment_address']['id_state']['logged']['display'] = 1;
            $configuration['payment_address']['id_country']['logged']['require'] = 1;
            $configuration['payment_address']['id_country']['logged']['display'] = 1;
            $configuration['payment_address']['phone']['logged']['display'] = 1;
            $configuration['payment_address']['phone']['logged']['require'] = 1;
            $configuration['payment_address']['phone_mobile']['logged']['require'] = 1;
            $configuration['payment_address']['phone_mobile']['logged']['display'] = 1;
            $configuration['payment_address']['alias']['logged']['require'] = 1;
            $configuration['payment_address']['alias']['logged']['display'] = 1;
            $configuration['payment_address']['other']['logged']['require'] = 1;
            $configuration['payment_address']['other']['logged']['display'] = 1;

            $configuration['shipping_address']['firstname']['logged']['require'] = 1;
            $configuration['shipping_address']['firstname']['logged']['display'] = 1;
            $configuration['shipping_address']['lastname']['logged']['require'] = 1;
            $configuration['shipping_address']['lastname']['logged']['display'] = 1;
            $configuration['shipping_address']['company']['logged']['require'] = 1;
            $configuration['shipping_address']['company']['logged']['display'] = 1;
            $configuration['shipping_address']['vat_number']['logged']['require'] = 1;
            $configuration['shipping_address']['vat_number']['logged']['display'] = 1;
            $configuration['shipping_address']['dni']['logged']['require'] = 1;
            $configuration['shipping_address']['dni']['logged']['display'] = 1;
            $configuration['shipping_address']['address1']['logged']['require'] = 1;
            $configuration['shipping_address']['address1']['logged']['display'] = 1;
            $configuration['shipping_address']['address2']['logged']['require'] = 1;
            $configuration['shipping_address']['address2']['logged']['display'] = 1;
            $configuration['shipping_address']['postcode']['logged']['require'] = 1;
            $configuration['shipping_address']['postcode']['logged']['display'] = 1;
            $configuration['shipping_address']['city']['logged']['require'] = 1;
            $configuration['shipping_address']['city']['logged']['display'] = 1;
            $configuration['shipping_address']['id_state']['logged']['require'] = 1;
            $configuration['shipping_address']['id_state']['logged']['display'] = 1;
            $configuration['shipping_address']['id_country']['logged']['require'] = 1;
            $configuration['shipping_address']['id_country']['logged']['display'] = 1;
            $configuration['shipping_address']['phone']['logged']['require'] = 1;
            $configuration['shipping_address']['phone']['logged']['display'] = 1;
            $configuration['shipping_address']['phone_mobile']['logged']['require'] = 1;
            $configuration['shipping_address']['phone_mobile']['logged']['display'] = 1;
            $configuration['shipping_address']['alias']['logged']['require'] = 1;
            $configuration['shipping_address']['alias']['logged']['display'] = 1;
            $configuration['shipping_address']['other']['logged']['require'] = 1;
            $configuration['shipping_address']['other']['logged']['display'] = 1;

            $configuration['payment_address']['firstname']['guest']['require'] = 1;
            $configuration['payment_address']['firstname']['guest']['display'] = 1;
            $configuration['payment_address']['lastname']['guest']['require'] = 1;
            $configuration['payment_address']['lastname']['guest']['display'] = 1;
            $configuration['payment_address']['company']['guest']['require'] = 1;
            $configuration['payment_address']['company']['guest']['display'] = 1;
            $configuration['payment_address']['vat_number']['guest']['require'] = 1;
            $configuration['payment_address']['vat_number']['guest']['display'] = 1;
            $configuration['payment_address']['dni']['guest']['require'] = 1;
            $configuration['payment_address']['dni']['guest']['display'] = 1;
            $configuration['payment_address']['address1']['guest']['require'] = 1;
            $configuration['payment_address']['address1']['guest']['display'] = 1;
            $configuration['payment_address']['address2']['guest']['require'] = 1;
            $configuration['payment_address']['address2']['guest']['display'] = 1;
            $configuration['payment_address']['postcode']['guest']['require'] = 1;
            $configuration['payment_address']['postcode']['guest']['display'] = 1;
            $configuration['payment_address']['city']['guest']['require'] = 1;
            $configuration['payment_address']['city']['guest']['display'] = 1;
            $configuration['payment_address']['id_state']['guest']['require'] = 1;
            $configuration['payment_address']['id_state']['guest']['display'] = 1;
            $configuration['payment_address']['id_country']['guest']['require'] = 1;
            $configuration['payment_address']['id_country']['guest']['display'] = 1;
            $configuration['payment_address']['phone']['guest']['display'] = 1;
            $configuration['payment_address']['phone']['guest']['require'] = 1;
            $configuration['payment_address']['phone_mobile']['guest']['require'] = 1;
            $configuration['payment_address']['phone_mobile']['guest']['display'] = 1;
            $configuration['payment_address']['alias']['guest']['require'] = 1;
            $configuration['payment_address']['alias']['guest']['display'] = 1;
            $configuration['payment_address']['other']['guest']['require'] = 1;
            $configuration['payment_address']['other']['guest']['display'] = 1;

            $configuration['shipping_address']['firstname']['guest']['require'] = 1;
            $configuration['shipping_address']['firstname']['guest']['display'] = 1;
            $configuration['shipping_address']['lastname']['guest']['require'] = 1;
            $configuration['shipping_address']['lastname']['guest']['display'] = 1;
            $configuration['shipping_address']['company']['guest']['require'] = 1;
            $configuration['shipping_address']['company']['guest']['display'] = 1;
            $configuration['shipping_address']['vat_number']['guest']['require'] = 1;
            $configuration['shipping_address']['vat_number']['guest']['display'] = 1;
            $configuration['shipping_address']['dni']['guest']['require'] = 1;
            $configuration['shipping_address']['dni']['guest']['display'] = 1;
            $configuration['shipping_address']['address1']['guest']['require'] = 1;
            $configuration['shipping_address']['address1']['guest']['display'] = 1;
            $configuration['shipping_address']['address2']['guest']['require'] = 1;
            $configuration['shipping_address']['address2']['guest']['display'] = 1;
            $configuration['shipping_address']['postcode']['guest']['require'] = 1;
            $configuration['shipping_address']['postcode']['guest']['display'] = 1;
            $configuration['shipping_address']['city']['guest']['require'] = 1;
            $configuration['shipping_address']['city']['guest']['display'] = 1;
            $configuration['shipping_address']['id_state']['guest']['require'] = 1;
            $configuration['shipping_address']['id_state']['guest']['display'] = 1;
            $configuration['shipping_address']['id_country']['guest']['require'] = 1;
            $configuration['shipping_address']['id_country']['guest']['display'] = 1;
            $configuration['shipping_address']['phone']['guest']['require'] = 1;
            $configuration['shipping_address']['phone']['guest']['display'] = 1;
            $configuration['shipping_address']['phone_mobile']['guest']['require'] = 1;
            $configuration['shipping_address']['phone_mobile']['guest']['display'] = 1;
            $configuration['shipping_address']['alias']['guest']['require'] = 1;
            $configuration['shipping_address']['alias']['guest']['display'] = 1;
            $configuration['shipping_address']['other']['guest']['require'] = 1;
            $configuration['shipping_address']['other']['guest']['display'] = 1;
        }
