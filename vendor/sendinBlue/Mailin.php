...
class KbSuperMailin
{
    ...
    */
    ...
    {
        /**
         * Start changes for fixing SendinBlue API issues
         * Changing resource name from list to lists
         * NAOct2023 brevo_list_lists
         * @date 13-10-2023
         * @author Nikhil Aggarwal
         */
        
         return $this->get("lists", json_encode($data));
    }
