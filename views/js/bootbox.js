...
window.bootbox =
  ...
  (function a(b, c) {
    ...
    var o = {
        ...
        inputs: {
          text: "<input class='bootbox-input form-control html_content' autocomplete=off type=text />",
        },
      },
      p = b("body"),
      q = {
    ...
    (r.alert = function () {
      var a;
      if (
        ((a = k(["ok"], arguments, ["message", "callback"])),
      ...
      (r.confirm = function () {
        var a;
        if (
          ((a = k(["cancel", "confirm"], arguments, ["message", "callback"])),
      ...
      (r.prompt = function () {
        ...
        if (
          ((f = b(o.form)),
          (d = { buttons: l("cancel", "confirm"), value: "" }),
          (a = n(j(d, arguments, ["title", "callback"]), [
            "cancel",
            "confirm",
          ])),
          (h = a.show === c ? !0 : a.show),
    ...
    var s = {
      br: { Save: "Save", CANCEL: "Cancelar", CONFIRM: "Sim" },
      da: { Save: "Save", CANCEL: "Annuller", CONFIRM: "Accepter" },
      de: { Save: "Save", CANCEL: "Abbrechen", CONFIRM: "Akzeptieren" },
      en: { Save: "Save", CANCEL: "Cancel", CONFIRM: "Save" },
      es: { Save: "Save", CANCEL: "Cancelar", CONFIRM: "Aceptar" },
      fi: { Save: "Save", CANCEL: "Peruuta", CONFIRM: "Save" },
      fr: { Save: "Save", CANCEL: "Annuler", CONFIRM: "D'accord" },
      it: { Save: "Save", CANCEL: "Annulla", CONFIRM: "Conferma" },
      nl: { Save: "Save", CANCEL: "Annuleren", CONFIRM: "Accepteren" },
      pl: { Save: "Save", CANCEL: "Anuluj", CONFIRM: "PotwierdÅº" },
      ru: {
        Save: "Save",
        CANCEL: "ÐžÑ‚Ð¼ÐµÐ½Ð°",
        CONFIRM: "ÐŸÑ€Ð¸Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ",
      },
      zh_CN: { Save: "Save", CANCEL: "å–æ¶ˆ", CONFIRM: "ç¡®è®¤" },
