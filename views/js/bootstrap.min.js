    ...
    (a.fn.tab = function (c) {
      ...
      a(document).on(
        ...
        function (b) {
          ...
          /* added for show current tab on 2 nov 2015 by gaurav pal*/
          b.preventDefault();
          var current_tab = a(this).attr("href");
          if (a(this).hasClass("lang-tab")) {
            if (a(this).parent().hasClass("vss-lang-tab-ver15")) {
              a(this).parent().siblings("li").removeClass("active");
              a(this).parent().addClass("active");
              a(
                ".velsof-container .tab-content > .vss-lang-tab-pane-ver15"
              ).hide();
            }
            a(".velsof-container .tab-content > form > .tab-pane").hide();
            a(".velsof-container .tab-content > .lang-active").show();
            a(current_tab).show();
          } else {
            if (a(this).parent().hasClass("vss-tab-ver15")) {
              a(this).parent().siblings("li").removeClass("active");
              a(this).parent().addClass("active");
            }
            a(".velsof-container .tab-content > form > .tab-pane").hide();
            a(".velsof-container .tab-content > .outsideform").hide();
            a(current_tab).show();
          }
          /*eoc*/
        }
