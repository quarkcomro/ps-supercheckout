  ...
  function (t, e, n) {
      ...
      return (
        ...
        (r = [
          ...
          },
          {
            ...
            value: function () {
              return (
                "order" === document.body.id || "order-opc" === document.body.id
              );
            },
          },
          {
      ...
      return (
        ...
        (r = [
          ...
          },
          {
            key: "isOrderPage",
            value: function () {
              return "checkout" === document.body.id;
            },
          },
          {
            key: "isNativeOnePageCheckoutPage",
          ...
          },
          {
            key: "isOrderPersonalInformationStepPage",
            value: function () {
              if ("checkout" !== document.body.id) return !1;
    ...
    (Wa = Qa(
      ...
      "loading" === document.readyState
        ? document.addEventListener("DOMContentLoaded", Wa)
        : Wa();
  },
]);
