...
(function(c) {
    ...
    c.tinysort = {
        id: "TinySort",
        version: "1.4.29",
        copyright: "Copyright (c) 2008-2025 Ron Valstar",
    ...
    c.fn.extend({
        tinysort: function(o, k) {
            ...
            var p = c.extend({}, c.tinysort.defaults, k),
                u, D = this,
                z = c(this).length,
                E = {},
                r = !(!o || o == ""),
                ...
                t = p.order == "rand" ? function() {
                    ...
                    if (!p.forceStrings) {
                        var H = J && J.match(i),
                            P = I && I.match(i);
                        if (H && P) {
                            var L = J.substr(0, J.length - H[0].length),
            ...
            D.each(function(I, J) {
                var K = c(J),
                    G = r ? (l ? m.filter(J) : K.find(o)) : K,
                    L = y ? "" + G.data(p.data) : (s ? G.attr(p.attr) : (p.useVal ? G.val() : G.text())),
                    H = K.parent();
                if (!E[H]) {
                    E[H] = {
                        s: [],
            ...
            for (u in E) {
                ...
                for (B = 0; B < z; B++) {
                    var q = b(C, B) ? !e : B >= F && B < F + A.s.length,
                        v = (q ? A.s : A.n)[w[q ? 0 : 1]].e;
                    v.parent().append(v);
                    if (q || !p.returns) {
                        n.push(v.get(0))
                    }
