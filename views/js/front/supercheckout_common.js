...
function toggleMenuHidden() {
  ...
  $("#menuVel").toggleClass("hidden-phone", function () {
    if ($(".container:first").is(".menu-hidden")) {
      if (typeof resetResizableMenu != "undefined") resetResizableMenu(true);
    } else {
...
function removeMenuHiddenPhone() {
  if (
    !$(".container:first").is(".menu-hidden") &&
    $("#menuVel").is(".hidden-phone")
  )
...
function genSparklines() {
  if ($(".sparkline").length) {
    $.each($("#content .sparkline"), function (k, v) {
      var size = { w: 150, h: 28 };
      if ($(this).parent().is(".widget-stats")) size = { w: 150, h: 35 };
    ...
    $.each($("#menuVel .sparkline"), function (k) {
      var size = { w: 150, h: 20 };
      if ($(this).parent().is(".widget-stats-3")) size = { w: 150, h: 35 };
...
$(function () {
  ...
  $(".navbar.main .btn-navbar").click(function () {
    var disabled =
      typeof toggleMenuButtonWhileTourOpen != "undefined"
        ? toggleMenuButtonWhileTourOpen(true)
        : false;
    if (!disabled) toggleMenuHidden();
  });
  ...
  $('.widget[data-toggle="collapse-widget"]').each(function () {
    ...
    $(this)
      .find(".widget-head")
      .append('<span class="collapse-toggle"></span>');
  ...
  $('[data-toggle*="gridalicious"]').each(function () {
    ...
    $(this)
      ...
      .gridalicious({
        ...
        width: $that.attr("data-gridalicious-width")
          ? parseInt($that.attr("data-gridalicious-width"))
          : 200,
        animate: true,
        selector: ".widget",
      });
  ...
  $('[data-toggle="hide"]').click(function () {
    ...
    if (
      $(this).is(".scrollTarget") &&
      !$($(this).attr("data-target")).is(".hide")
    )
  ...
  $("#toggle-menu-position").on("change", function () {
    ...
    else $(".container-960:first").addClass("menu-left");

    if (typeof $.cookie != "undefined")
      $.cookie(
        "rightMenu",
        $(this).prop("checked") ? $(this).prop("checked") : null
      );

    if (
      typeof resetResizableMenu != "undefined" &&
      typeof lastResizableMenuPosition != "undefined"
    ) {
      resetResizableMenu(true);
      lastResizableMenuPosition();
    }
  ...
  $("#toggle-layout").on("change", function () {
    ...
    } else $(".container:first").removeClass("fixed");
  ...
  if (
    (typeof $.cookie != "undefined" &&
      $.cookie("menuHidden") &&
      $.cookie("menuHidden") == "true") ||
    (!$(".container").is(".menu-hidden") && !$("#menuVel").is(":visible"))
  )
    toggleMenuHidden();
