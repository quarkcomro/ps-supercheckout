...
$(function () {
        ...
        buttons:
          self.data("type") != "confirm"
            ...
            : [
                {
                  addClass:
                    "btn btn-success btn-small glyphicons btn-icon ok_2",
                  text: "<i></i> Ok",
                ...
                {
                  addClass:
                    "btn btn-danger btn-small glyphicons btn-icon remove_2",
                  text: "Cancel",
                  onClick: function ($notyfy) {
                    $notyfy.close();
                    $(self.data("custom")).notyfy({
      ...
      buttons:
        self.data("type") != "confirm"
          ...
          : [
              ...
              {
                addClass:
                  "btn btn-danger btn-small btn-icon glyphicons remove_2",
                text: "<i></i> Cancel",
                onClick: function ($notyfy) {
                  $notyfy.close();
                  notyfy({
  ...
  $(".gritter-add-sticky").click(function () {
    var unique_id = $.gritter.add({
      ...
      image:
        "https://si0.twimg.com/profile_images/2873657673/f56ad0e8a62b588ad92b19969084b2ab_bigger.png",
...
notification["alert"] =
  "Best check yo self, you'<strong>re not looking too good</strong>.";
notification["primary"] =
  "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.";
notification["error"] =
  "<strong>Change a few things up and try submitting again.</strong> This Error message.";
notification["success"] =
  "You <strong>successfully</strong> read this important alert message.";
notification["information"] =
  "This alert needs your attention, but it's not super <strong>important</strong>.";
