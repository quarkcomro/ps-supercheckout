...
var velovalidation = {
  language: {},
  script_regex:
    /(<script[\s\S]*?>[\s\S]*?<\/script>)|(<script[\s\S]*?>)|([\s\S]*?<\/script>)/i,
  style_regex:
    /(<style[\s\S]*?>[\s\S]*?<\/style>)|(<style[\s\S]*?>)|([\s\S]*?<\/style>)/i,
  iframe_regex:
    /(<iframe[\s\S]*?>[\s\S]*?<\/iframe>)|(<iframe[\s\S]*?>)|([\s\S]*?<\/iframe>)/i,
  specail_chars: "*|,\":<>[]{}`';()@&$#%",
    ...
    if (val != "") {
      ...
      if (val.length <= maxchar) {
        if (val.length < minchar) {
          ...
          if (!val.match(".*\\d.*")) return velovalidation.error("digit_pass");
  ...
  checkCountry: function (ele) {
    ...
    if (val != "") {
      ...
      if (val.length <= maxchar) {
        if (val.length < minchar) {
          return_val = velovalidation
            .error("minchar_country")
            .replace(/#/g, minchar);
        }
      } else {
        return_val = velovalidation
          .error("maxchar_country")
          .replace(/#/g, maxchar);
      }
    }
    return return_val;
  ...
  checkProductName: function (ele) {
    ...
    if (val != "") {
      ...
      if (val.length <= maxchar) {
        if (val.length < minchar) {
          return_val = velovalidation
            .error("minchar_proname")
            .replace(/#/g, minchar);
        }
      } else {
        return_val = velovalidation
          .error("maxchar_proname")
          .replace(/#/g, maxchar);
      }
    }
    return return_val;
  ...
  checkCategoryName: function (ele) {
    ...
    if (val != "") {
      ...
      if (val.length <= maxchar) {
        if (val.length < minchar) {
          return_val = velovalidation
            .error("minchar_catname")
            .replace(/#/g, minchar);
        }
      } else {
        return_val = velovalidation
          .error("maxchar_catname")
          .replace(/#/g, maxchar);
      }
    }
    return return_val;
  ...
  checkUsername: function (ele) {
    ...
    if (val != "") {
      ...
      if (val.length <= maxchar) {
        if (val.length < minchar) {
          return_val = velovalidation
            .error("minchar_username")
            .replace(/#/g, minchar);
        }
      } else {
        return_val = velovalidation
          .error("maxchar_username")
          .replace(/#/g, maxchar);
      }
    }
    return return_val;
  ...
  checkAddress: function (ele) {
    ...
    if (val != "") {
      ...
      if (val.length <= maxchar) {
        if (val.length < minchar) {
          return_val = velovalidation
            .error("minchar_address")
            .replace(/#/g, minchar);
        }
      } else {
        return_val = velovalidation
          .error("maxchar_address")
          .replace(/#/g, maxchar);
      }
    }
  ...
  error: function (key) {
    var error_arr = {
      ...
      validate_range:
        "Number is not in the valid range. It should be betwen # and ##",
