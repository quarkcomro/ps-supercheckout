                        ...
                        <tr class="supercheckout_edit_custom_field_form_fields {if $show_option_field eq 0}hidden_custom{/if}" id="edit_field_options">
                            ...
                            <td class="supercheckout_popup_form_field">
                                <div class="span">
                                    <span class='float_left margin_right_20'>
                                        {foreach $languages as $language}
                                            <textarea class="supercheckout_edit_field_options {if $language_current neq $language['id_lang']}hidden_custom{/if}" id='edit_field_options_language_{$language['id_lang']}' name="edit_custom_fields[field_options][{$language['id_lang']}]">{if isset($custom_field_option_details[$language['id_lang']]) && $custom_field_option_details[$language['id_lang']] ne ''}{$custom_field_option_details[$language['id_lang']]}{/if}</textarea>
                                        {/foreach}
                                    </span>
                                    <span class='float_left'>
                            ...
                            <td class="supercheckout_popup_form_field">
                                <div class="span5">
                                    <select class="dropdn_templates" name="edit_custom_fields[position]">
                                        <option value="shipping_address_form" {if $custom_field_basic_details['type'] eq "textbox"}selected{/if}>{l s='Shipping Address Form' mod='supercheckout'}</option>
                        ...
                        <tr>
                            ...
                            <td class="supercheckout_popup_form_field">
                                <div class="form-group">
                                    <div class="col-lg-9">
                                        <span class="switch prestashop-switch fixed-width-lg">
                                            <input type="radio" name="edit_custom_fields[show_invoice]" id="edit_custom_fields[show_invoice]_on" value="1" {if $custom_field_basic_details['show_invoice'] eq "1"}checked="checked"{/if}>
                                            <label for="edit_custom_fields[show_invoice]_on">{l s='Yes' mod='supercheckout'}</label>
                                            <input type="radio" name="edit_custom_fields[show_invoice]" id="edit_custom_fields[show_invoice]_off" value="0" {if $custom_field_basic_details['show_invoice'] eq "0"}checked="checked"{/if}>
                                            <label for="edit_custom_fields[show_invoice]_off">{l s='No' mod='supercheckout'}</label>
                                            <a class="slide-button btn"></a>
                                        </span>
                                    </div>
                                </div>
