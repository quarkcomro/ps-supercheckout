...
{else}
    ...
    <!-- Start - Code to insert custom fields in registration form block -->
   {*
    * Fixes to show the custom field block only is if its marked to show
    * @date 22-04-2026
    * @modifier Manish
    *}
     <div class="div_custom_fields" id="registration_custom_fields_block" style="display:{if $settings['checkout_option'] eq 0}none{else}block{/if};">
                        {foreach from=$array_fields item=field}
                            {if $field['position'] eq 'customer_registration_block'}
                                <div class="supercheckout-blocks form-group">
                                    {if $field['type'] eq "textbox"}
    ...
    <div id="social_login_block" style="display: none;">
        ...
        {if $settings['fb_login']['enable'] neq 1 && $settings['google_login']['enable'] neq 1 && $settings['paypal_login']['enable'] neq 1}
            {* Start Changes to fix the issue of the  Undefined array key "status" on supercheckout
             * Adding isset for $show_on_supercheckout['status']
             * NASep2023 show_on_supercheckout
             * @date 27-09-2023
             * @modifier Nikhil Aggarwal
             *}
            {if isset($show_on_supercheckout) && isset($show_on_supercheckout['status']) && $show_on_supercheckout['status'] == 1}
            ...
            {/if}
        {/if}
        {if $settings['fb_login']['enable'] eq 1 || $settings['google_login']['enable'] eq 1 || $settings['paypal_login']['enable'] eq 1}
            <div class="social-login">
                ...
                {*
                 * Updated facebook login url based on condition that whether the supercheckout url contains ? or not
                 * @date 31-01-2023
                ...
                {if $settings['fb_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        ...
                        * @modifier Nikhil Aggarwal
                        *}
                        <a onclick="return !window.open(this.href, 'popup', 'width=450,height=300,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|stst:"?"}&myfbLogin {else}?myfbLogin{/if}" class="fbButton btn azm-social azm-btn azm-pill azm-facebook" id="fb-auth" ><i class="fa fa-facebook"></i>  Facebook</a>
                        {*escape not required as contains url*}
                        
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|stst:"?"}&myfbLogin {else}?myfbLogin{/if}" class="fbButton btn azm-social azm-btn azm-pill azm-facebook" id="fb-auth" ><i class="fa fa-facebook"></i> Facebook</a> 
                        {* Changes end by Nikhil *}
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                {*
                 * Updated google login url based on condition that whether the supercheckout url contains ? or not
                 * @date 31-01-2023
                 * @commenter Prvind Panday
                 *}
                {if $settings['google_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        ...
                        * @modifier Nikhil Aggarwal
                        *}
                        <a onclick="return !window.open(this.href, 'popup', 'width=500,height=500,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|stst:"?"}&myGoogleLogin {else}?myGoogleLogin{/if}" class="googleButton btn azm-social azm-btn azm-pill azm-google-plus" ><i class="fab fa-google"></i> Google</a>
                        {*escape not required as contains url*}
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|stst:"?"}&myGoogleLogin {else}?myGoogleLogin{/if}" class="googleButton btn azm-social azm-btn azm-pill azm-google-plus" ><i class="fab fa-google"></i> Google</a>
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                {*
                 * Updated paypal login url based on condition that whether the supercheckout url contains ? or not
                 * @date 31-01-2023
                 * @commenter Prvind Panday
                 *}
                {if $settings['paypal_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        <a onclick="return !window.open(this.href, 'popup', 'width=500,height=500,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|stst:"?"}&myPaypalLogin {else}?myPaypalLogin{/if}" class="btn azm-social azm-btn azm-border-bottom azm-paypal" style="color: #ffffff; background: #009cde;"><i class="fa fa-paypal"></i>Login with Paypal</a>
                        {*escape not required as contains url*}
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|stst:"?"}&myPaypalLogin {else}?myPaypalLogin{/if}"class="btn azm-social azm-btn azm-border-bottom azm-paypal" style="color: #ffffff; background: #009cde;"><i class="fa fa-paypal"></i>Login with Paypal</a>
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                {* Changes end by Nikhil for strstr *}
                </div>
