                            ...
                            {else}
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group ">
                                        ...
                                        <label class="control-label"for="payment_address[{$p_address_key}]" {if $p_address_key eq "postcode"} style="font-size: 14px;"{/if}>{l s={$settings['payment_address'][$p_address_key]['title']} mod='supercheckout'}:
                                            ...
                                            {else if $p_address_key eq 'dni'}
                                                <span {if $need_dni}class="supercheckout-required"{/if}>*</span>
                                            {else}
