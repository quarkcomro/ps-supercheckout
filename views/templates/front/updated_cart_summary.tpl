...
<div class="table-responsive">
    <table class="supercheckout-summary table table-bordered shoppingTable">
        ...
        <th style="{if $logged}{if $settings['cart_options']['product_availability']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_availability']['guest']['display'] eq 1}{else}none{/if}{/if};" class="supercheckout-qty" style="text-align:center;">{l s='Availability' mod='supercheckout'}</th>
        {/if}
        {*End-MK made changes to display availability column*}
        <th style="{if $logged}{if $settings['cart_options']['product_qty']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_qty']['guest']['display'] eq 1}{else}none{/if}{/if};" class="supercheckout-qty" style="text-align:center;">{l s='Qty' mod='supercheckout'}</th>
        <th style="{if $logged}{if $settings['cart_options']['product_price']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_price']['guest']['display'] eq 1}{else}none{/if}{/if};" class="supercheckout-total">{l s='Price' mod='supercheckout'}</th>
        <th style="{if $logged}{if $settings['cart_options']['product_total']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_total']['guest']['display'] eq 1}{else}none{/if}{/if};" class="supercheckout-total">{l s='Total' mod='supercheckout'}</th>
        ...
        <tbody>
            ...
            {foreach $products as $product}
                ...
                <tr id="product_{$product.id_product|intval}_{$product.id_product_attribute|intval}_{$product.id_address_delivery|intval}_{$product.id_customization|intval}">
                    ...
                    {/if}
                    <td class="supercheckout-name text-left td-product" style="{if $logged}{if $settings['cart_options']['product_name']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_name']['guest']['display'] eq 1}{else}none{/if}{/if};">
                        {if $image_display eq 1}
                        ...
                        {if isset($product.attributes) && count($product.attributes) > 0}
                            ...
                            {/foreach}
                        {/if}
                        <p style="{if $logged}{if $settings['cart_options']['product_model']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_model']['guest']['display'] eq 1}{else}none{/if}{/if};" class="supercheckout-model"><b>{l s='Model' mod='supercheckout'}:</b> {if $product.reference}{$product.reference}{/if}</p>
                        {if $PS_STOCK_MANAGEMENT}
                            <p style="{if $logged}{if $settings['cart_options']['product_availability']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_availability']['guest']['display'] eq 1}{else}none{/if}{/if};"><b>{l s='Availability' mod='supercheckout'}:</b> <span class="badge badge-success">
                    ...
                    <td style="{if $logged}{if $settings['cart_options']['product_qty']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_qty']['guest']['display'] eq 1}{else}none{/if}{/if};" class="supercheckout-qty supercheckout-product-qty-input" >
        ...
        {foreach from=$subtotals item="subtotal"}
            ...
            {if isset($subtotal.value) && $subtotal.value}
                {if $subtotal.type == 'products'}
                    <tr id="supercehckout_summary_total_{$subtotal.type}" style="{if $logged}{if $settings['order_total_option']['product_sub_total']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['order_total_option']['product_sub_total']['guest']['display'] eq 1}{else}none{/if}{/if};">
                    {else if $subtotal.type == 'shipping'}
                    <tr id="supercehckout_summary_total_{$subtotal.type}" style="{if $logged}{if $settings['order_total_option']['shipping_price']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['order_total_option']['shipping_price']['guest']['display'] eq 1}{else}none{/if}{/if};">
                    {else if $subtotal.type == 'tax'}
                    <tr id="supercehckout_summary_total_{$subtotal.type}" style="{if $logged}{if $settings['order_total_option']['total_tax']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['order_total_option']['total_tax']['guest']['display'] eq 1}{else}none{/if}{/if};">
                    {else}
...
<div class="custom-panel rewardsection">
    ...
    {/if}
    <div class="totalAmount" style="{if $logged}{if $settings['order_total_option']['total']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['order_total_option']['total']['guest']['display'] eq 1}{else}none{/if}{/if};">
        <h3>
            {if $priceDisplay == 1}
