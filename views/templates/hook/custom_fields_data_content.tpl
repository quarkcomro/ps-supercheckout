...
<div class="tab-pane" id="custom_fields_data_content">
    ...
    <h4 class="visible-print">{l s='Customer Profile : ' mod='supercheckout'} {$customer_profile}<span class="badge"></span></h4>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="col-lg-6">
                        {if $field_data['type'] == 'file'}
                            {assign var=file_path value=$field_data['field_value']|json_decode:1}
